...
The repository-setting switch occurs only after the first consumer-safe distribution tag is published and verified. Until then, the source remains the template to avoid directing users to an older generated snapshot.
